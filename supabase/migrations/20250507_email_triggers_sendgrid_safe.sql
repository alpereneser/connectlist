-- SendGrid ile e-posta bildirimleri için veritabanı tetikleyicileri (Güvenli Versiyon)
...
BEGIN
  ...
  EXCEPTION
    WHEN undefined_table THEN
      RAISE WARNING 'user_email_preferences tablosu bulunamadı';
      RETURN NEW;
  END;
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'follows tablosu bulunamadı, tetikleyici oluşturulamadı';
  END IF;
END
$$;
...
BEGIN
  ...
  EXCEPTION
    WHEN undefined_table THEN
      RAISE WARNING 'lists tablosu bulunamadı';
      RETURN NEW;
  END;
  ...
  EXCEPTION
    WHEN undefined_table THEN
      RAISE WARNING 'list_likes veya user_email_preferences tablosu bulunamadı';
  END;
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'list_items tablosu bulunamadı, tetikleyici oluşturulamadı';
  END IF;
END
$$;
...
BEGIN
  ...
  EXCEPTION
    WHEN undefined_table THEN
      RAISE WARNING 'comments, lists veya profiles tablosu bulunamadı';
      RETURN NEW;
  END;
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'comments tablosu bulunamadı, tetikleyici oluşturulamadı';
  END IF;
END
$$;
...
BEGIN
  ...
  EXCEPTION
    WHEN undefined_table THEN
      RAISE WARNING 'conversations tablosu bulunamadı';
      RETURN NEW;
  END;
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'messages tablosu bulunamadı, tetikleyici oluşturulamadı';
  END IF;
END
$$;
