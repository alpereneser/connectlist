...
export function ShareModal({ isOpen, onClose, url, title, description }: ShareModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50">
      <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:w-96 max-w-md p-6 animate-slide-up">
        {/* Header */}
        ...
        {/* Content Info */}
        <div className="mb-6">
          <h4 className="font-medium text-gray-900 mb-1 line-clamp-2">{title}</h4>
          {description && (
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg transition-colors border-t pt-4 mt-4"
          >
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
