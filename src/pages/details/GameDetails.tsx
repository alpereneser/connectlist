  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content={`https://connectlist.me/game/${id}`} />
        <meta property="og:title" content={gameTitleWithYear} />
        <meta property="og:description" content={metaDescription || t('social.meta.gameDescription', { title: game.name })} />
        <meta property="og:image" content={game.background_image} />
        <meta property="og:image:width" content="1920" />
        <meta property="og:image:height" content="1080" />
        <meta property="og:image:alt" content={`${game.name} ${t('social.meta.defaultImage')}`} />
        ...
        {/* Game specific Open Graph */}
        {game.released && <meta property="game:release_date" content={game.released} />}
        {game.rating && <meta property="game:rating" content={game.rating.toString()} />}
        {game.platforms && game.platforms.map(platform => (
          <meta key={platform.platform.id} property="game:platform" content={platform.platform.name} />
        ))}
        {game.genres && game.genres.map(genre => (
          <meta key={genre.id} property="game:tag" content={genre.name} />
        ))}
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@connectlist" />
        <meta name="twitter:title" content={gameTitleWithYear} />
        <meta name="twitter:description" content={metaDescription} />
        <meta name="twitter:image" content={game.background_image} />
        <meta name="twitter:image:alt" content={`${game.name} game screenshot`} />
        
        {/* WhatsApp specific meta tags */}
        <meta property="og:image:type" content="image/jpeg" />
        <meta property="og:image:secure_url" content={game.background_image} />
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex items-end gap-4 mb-4">
                  <div className="w-32 h-44 rounded-lg overflow-hidden shadow-lg border-2 border-white">
                    <img 
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-base text-white flex-wrap">
                      {game.metacritic && (
                ...
                <div className="mt-4 flex flex-wrap gap-3 items-center">
                  <button
                    ...
                    className="flex items-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 shadow-md"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-lg transition duration-200 shadow-md"
                  >
            ...
            <div className="relative z-10 pt-8 pb-4 px-4">
              <div className="flex gap-4 items-end">
                ...
                <div className="flex-1 text-white pb-2">
                  <h1 className="text-xl font-bold mb-2 leading-tight">{game.name}</h1>
        ...
        <div className="bg-gray-50 min-h-screen">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {game.platforms.map((platform) => (
                              <span key={platform.platform.id} className="inline-block px-3 py-1 bg-gray-100 rounded-md text-sm">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {game.genres.map((genre) => (
                              <span key={genre.id} className="inline-block px-3 py-1 bg-gray-100 rounded-md text-sm">
                                {genre.name}
                              </span>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {game.developers.map((developer) => (
                              <span key={developer.id} className="inline-block px-3 py-1 bg-gray-100 rounded-md text-sm">
                                {developer.name}
                              </span>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {game.publishers.map((publisher) => (
                              <span key={publisher.id} className="inline-block px-3 py-1 bg-gray-100 rounded-md text-sm">
                                {publisher.name}
                              </span>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {game.tags.slice(0, 10).map((tag) => (
                              <span key={tag.id} className="inline-block px-3 py-1 bg-gray-100 rounded-md text-sm">
                                {tag.name}
                              </span>
                            ))}
                          </div>
          ...
          <div className="md:hidden">
            <div className="px-4 py-4 space-y-4">
              ...
              {/* Listesine Ekleyenler - Mobil */}
              {listUsers.length > 0 && (
                <div className="bg-white rounded-lg shadow-sm p-4">
                  <h3 className="font-semibold text-gray-700 mb-3">Listesine Ekleyenler</h3>
                  <div className="space-y-3">
                    {listUsers.slice(0, 3).map((user, index) => (
                      <div 
                        key={index}
